export const sl = {
  ...
  becomeCarrier: {
    badge: "Pridruži se mreži prevoznikov",
    heroTitle: "Razvij svoj prevozniški posel z Ipsilonom",
    heroDescription: "Vedno več ljudi uporablja Ipsilon za iskanje prevoza svojega tovora. Od vozil do pohištva – uporabi ultra-optimizirane filtre za odkrivanje poslov, ki ti popolnoma ustrezajo. Zapolni prazen tovorni prostor in zasluži več.",
    ctaButton: "Ustvari račun in postani prevoznik",
    ctaTitle: "Pripravljen na zaslužek?",
    ctaDescription: "Pridruži se prevoznikom, ki že rastejo z Ipsilonom. Registracija traja le 2 minuti.",
    benefit1Title: "Hitro in enostavno",
    benefit1Desc: "Registracija v samo 2 minutah, brez dolgotrajne birokracije.",
    benefit2Title: "Popoln nadzor nad cenami",
    benefit2Desc: "Ti odločaš, koliko želiš zaslužiti.",
    benefit3Title: "Ocene in zaupanje",
    benefit3Desc: "Gradi svojo reputacijo z ocenami uporabnikov.",
    benefit4Title: "Brez obveznosti",
    benefit4Desc: "Sprejmi samo posle, ki ti ustrezajo.",
    categoriesTitle: "Kategorije prevoza, ki jih pokrivamo",
    categoriesSubtitle: "Od majhnih paketov do težke mehanizacije — dela je za vsak tip prevoznika",
    categoryCars: "Avtomobili",
    categoryMotorcycles: "Motorji",
    categoryCommercial: "Gospodarska vozila",
    categoryMachinery: "Stroji in orodje",
    categoryFurniture: "Pohištvo in gospodinjstvo",
    categoryBoxes: "Škatle in paketi",
    categoryPallets: "Palete",
    categoryMoves: "Kompletna selitev",
    categoryPets: "Hišni ljubljenčki",
    categoryDebris: "Gradbeni odpadki",
    howItWorksTitle: "Kako deluje",
    step1Title: "Ustvari račun",
    step1Desc: "Izpolni kratek vprašalnik o svojih storitvah in vozilih.",
    step2Title: "Bodi verificiran",
    step2Desc: "Naša ekipa pregleda tvojo prijavo v 24 urah.",
    step3Title: "Začni zaslužiti",
    step3Desc: "Pregleduj oglase, pošiljaj ponudbe in razvijaj posel.",
  },
